            ...
            <div className="flex h-full items-center justify-between px-4 lg:px-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/" className="flex items-center gap-2.5">
                        <ApplicationLogo className="block h-8 w-auto fill-current text-[#A7F3D0] dark:text-indigo-400" />
                        <span className="text-lg font-bold tracking-tight text-white dark:text-white hidden sm:inline">
                            CoreERP
                        </span>
                    </Link>
                </div>
                ...
                <div className="flex items-center gap-3.5">
                    ...
                    <div className="h-5 w-px bg-slate-600 dark:bg-slate-700 mx-1" />
                        ...
                        <Dropdown>
                            <Dropdown.Trigger>
                                <span className="inline-flex rounded-md">
                                    <button
                                        type="button"
                                        className="inline-flex items-center gap-2 rounded-xl border border-transparent bg-transparent py-1.5 pe-2 ps-1 text-sm font-semibold text-slate-200 transition duration-150 ease-in-out hover:text-white focus:outline-none dark:text-slate-300 dark:hover:text-slate-100"
                                    >
                                        {/* Avatar Initials */}
                                        <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-indigo-500/20 text-xs font-bold text-indigo-300 dark:bg-indigo-500/10 dark:text-indigo-400">
